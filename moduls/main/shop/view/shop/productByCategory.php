<?php $category = $data->category; ?>
 <style>
    .page_head:before{
        background-image: url('/resources/files/upload/category/<?php echo $category->category_image; ?>');
    }
</style>
...
<div class="page_content">
    <div class="inner_content shop_content"
    data-category="<?php echo $category->category_id; ?>"
    data-start="<?php echo count($data->product); ?>">
        <div class="row">
        ...
        <div class="load_more">
            <a class="productbycategoryloadmore">
                load more
            </a>
        </div>
        <?php endif; ?>
